...
<head>
    ...
    <title>CPR Vision Tech Test</title>
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/icon/ico.ico" type="image/x-icon">
    <!-- Bootstrap CSS -->
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="display">
                  ...
                  <tr>
                            ...
                            <?php
                                $no=1;
                                foreach($report->result_array() as $dp)
                                {
                            ?>
                            <tr>
                                <td><?php echo $no; ?></td>
                                <td><?php echo $dp['pin']; ?></td>
                                <td><?php echo $dp['mac']; ?></td>
